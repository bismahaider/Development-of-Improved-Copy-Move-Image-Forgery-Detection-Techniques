...
class ImageObject(object):
    ...
    def __init__(self, input_path, image_name, output_directory, block_dimension):
        ...
        self.Nf = 288 # minimum treshold of the offset's frequency
        self.Nd = 25  # minimum treshold of the offset's magnitude

        # algorithm's parameters from the second paper
        self.P = (1.10, 1.10, 1.10, 0.0200, 0.0200, 0.0200, 0.0200)
        self.t1 = 0.1
        self.t2 = 0.009
    ...
    def run(self):
        ...
        print("Computing time :", abs(timestamp_after_computing - start_timestamp), "second")
        print("Sorting time   :", abs(timestamp_after_sorting - timestamp_after_computing), "second")
        print("Analyzing time :", abs(timestamp_after_analyze - timestamp_after_sorting), "second")
        print("Image creation :", abs(timestamp_after_image_creation - timestamp_after_analyze), "second")
